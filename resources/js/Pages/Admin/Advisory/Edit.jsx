...
function Create() {
    const { item, teams } = usePage().props;
    ...
    const { data, setData, put, processing, errors, reset } = useForm({
        ...
        subtitle_eng: item.subtitle_eng || "",
        subtitle_jpn: item.subtitle_jpn || "",
        slug: item.slug || "",
        ...
        highlight_eng: item.highlight_eng || "",
        highlight: item.highlight || "",
        highlight_jpn: item.highlight_jpn || "",
    ...
    const onHandleSubmit = (e) => {
        e.preventDefault();
        put(
            route("advisories.update", item.id),
            {
                onStart: () => {
                    toggleSpinner(true);
                },
