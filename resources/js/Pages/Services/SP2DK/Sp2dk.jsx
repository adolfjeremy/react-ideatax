...
function Sp2dk() {
    ...
    return (
        ...
        >
            ...
            <Cause locale={locale} checkLang={checkLang} theme={theme} />
            <Role locale={locale} checkLang={checkLang} theme={theme} />
            <WhyChoose locale={locale} checkLang={checkLang} theme={theme} />
            <CountUp
                locale={locale}
                checkLang={checkLang}
                theme={theme}
